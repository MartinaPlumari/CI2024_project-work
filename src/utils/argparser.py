...
def parse_cmd_arguments():
    ...
    parser.add_argument('--popsize', type=int, default=5000, help='Population size.')
    parser.add_argument('--offsize', type=int, default=5000, help='Offspring size.')
    parser.add_argument('--maxgen', type=int, default=1000, help='Max train generations.')
